...
export class ArtistasServiceService {
  ...
  artistas = [
    ...
    { id: '2', nombre: 'Ana', especilidad: 'Especializada en: Microrealismo, Fineline y Blackwork', descripcion: 'Ana es nuestra experta en el microrealismo, fineline y blacwork', imagen: 'artistas/ana.jpg', tatuajes: 'tatuajes-ana',ig: 'anaplaza.tattoo'},
